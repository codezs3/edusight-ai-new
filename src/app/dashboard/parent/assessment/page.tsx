...
interface AssessmentCardProps {
  title: string;
  description: string;
  type: 'academic' | 'psychological' | 'physical' | 'comprehensive' | 'skills';
...
export default function ParentAssessmentDashboard() {
  ...
  const [selectedType, setSelectedType] = useState<'all' | 'academic' | 'psychological' | 'physical' | 'skills'>('all');
  ...
  const assessments = [
    ...
    },
    {
      ...
      description: 'Essential life skills, critical thinking, creativity, and problem-solving abilities evaluation.',
  ...
  const quickActions = [
    {
      ...
      description: 'Access comprehensive assessment reports for your children',
    ...
    },
    {
      ...
      description: 'Plan and schedule upcoming assessments',
      icon: CalendarIcon,
      color: 'bg-blue-500',
