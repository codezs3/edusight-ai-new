...
export default function UnifiedAssessmentWorkflow({ 
  ...
  const workflowSteps: WorkflowStep[] = [
    ...
    },
    {
      ...
      description: 'Creating comprehensive assessment reports',
      status: 'pending',
      progress: 0,
      subSteps: [
        ...
        { id: 'export_preparation', title: 'Export Preparation', description: 'Preparing downloadable reports and analytics', status: 'pending' }
      ]
    }
  ];
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <PDFDownloadButton
            ...
            userRole={userRole}
            paymentStatus={isAdmin ? "ADMIN" : "PAID"}
            isDemo={!isAdmin}
          />
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-sm text-gray-500 mt-2">
          User Type: {userTypeConfig.name} • {isAdmin ? 'Full Access' : 'Standard Access'}
        </p>
      </div>
      ...
      {!isRunning && (
        <div className="text-center">
          <button
            ...
            disabled={showUpload && files.length === 0}
            className="bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold py-4 px-8 rounded-lg hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center space-x-2 mx-auto"
          >
