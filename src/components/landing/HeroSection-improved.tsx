...
export function HeroSection() {
  ...
  const keyFeatures = [
    'EduSight 360° Comprehensive Assessment',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            <p className="text-lg lg:text-xl text-edu-gray-600 mb-8 max-w-2xl mx-auto lg:mx-0">
              Get comprehensive insights with our EduSight 360° Score covering academic, psychological, 
              and physical assessments across all major educational frameworks.
            </p>
