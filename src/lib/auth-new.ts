...
export const authConfig: NextAuthConfig = {
  // Temporarily disable Prisma adapter to fix NextAuth errors
  ...
  providers: [
    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        // TEMPORARY BYPASS: Always return demo admin user
        console.log('🔓 LOGIN SYSTEM DISABLED - Auto-logging in as demo admin');
  ...
  callbacks: {
    ...
    async signIn({ user, account }) {
      // Temporarily disabled Prisma operations
